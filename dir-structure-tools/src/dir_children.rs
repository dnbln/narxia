...
#[cfg(feature = "async")]
use dir_structure::traits::asy::ReadFromAsync;
#[cfg(feature = "async")]
...
use dir_structure::traits::vfs::DirEntryInfo;
use dir_structure::traits::vfs::DirWalker as _;
#[cfg(feature = "resolve-path")]
...
///
/// use dir_structure::traits::sync::{DirStructure, DirStructureItem};
/// use dir_structure_tools::dir_children::{DirChildren, Filter};
/// use dir_structure::prelude::*;
///
...
///
/// dir_structure_tools::ext_filter!(RustFile, "rs");
///
...
/// use dir_structure_tools::dir_children::Filter;
///
/// dir_structure_tools::stem_filter!(MainFile, "main");
///
...
/// use dir_structure_tools::dir_children::Filter;
///
/// dir_structure_tools::file_prefix_filter!(LogFile, "log");
///
...
impl<T, F: Filter<P>, P: PathType + ?Sized> DirChildren<T, F, P> {
    ...
    /// ```
    /// use std::path::PathBuf;
    /// use dir_structure_tools::{dir_children::DirChildren, NoFilter};
    ///
    ...
    ///
    /// ```
    /// use dir_structure_tools::{dir_children::{DirChildren, DirChild}, NoFilter};
    ///
    ...
    /// use std::pin::Pin;
    /// use dir_structure::prelude::*;
    /// use dir_structure_tools::dir_children::{DirChildren, DirChild};
    ///
    /// #[derive(Debug, PartialEq, Eq)]
    /// struct NewType(String);
    ///
    /// let dir = DirChildren::<_, dir_structure_tools::NoFilter>::with_children_from_iter(
    ///     vec![
    ///         DirChild::new("file1.txt", "file1".to_owned()),
    ///         DirChild::new("file2.txt", "file2".to_owned()),
    ...
    ///     ],
    /// );
    /// let dir = dir.map::<_, _, dir_structure_tools::NoFilter, Path>(|child| child.map_value(NewType));
    /// assert_eq!(
    ///     dir,
    ...
    /// use std::path::Path;
    /// use dir_structure::traits::vfs::PathType;
    /// use dir_structure_tools::dir_children::{Filter, DirChildren};
    ///
    /// struct NewFilter;
    ///
    ...
    /// }
    ///
    /// let d = DirChildren::<String, dir_structure_tools::NoFilter>::new();
    ...
    /// assert_eq!(d.len(), 0);
    ///
    /// let d = DirChildren::<String, dir_structure_tools::NoFilter>::with_children_from_iter(
    ///     vec![
    ///         DirChild::new("file1.txt", "file1".to_owned()),
    ///         DirChild::new("file2.txt", "file2".to_owned()),
    ///     ],
    ...
    /// use dir_structure_tools::dir_children::{DirChildren, DirChild};
    ///
    /// let mut d = DirChildren::<String, dir_structure_tools::NoFilter>::new();
    /// assert_eq!(d.get_mut(0), None);
    /// assert_eq!(d.get_mut(1), None);
    /// assert_eq!(d.get_mut(100), None);
    ///
    /// let mut d = DirChildren::<String, dir_structure_tools::NoFilter>::with_children_from_iter(
    ///     vec![
    ///         DirChild::new("file1.txt", "file1".to_owned()),
    ///         DirChild::new("file2.txt", "file2".to_owned()),
    ///     ],
...
impl<T, F: Filter<P>, P: PathType + ?Sized> DirChildSingle<T, F, P> {
    ...
    /// struct Filt;
    ///
    /// impl<P: PathType + ?Sized> dir_structure_tools::dir_children::Filter<P> for Filt {
    ///     fn allows(_path: &P) -> bool {
    ///         true
    ///     }
    /// }
    ...
    P: PathType + ?Sized,
{
    ...
    ///
    /// ```rust
    /// use dir_structure_tools::dir_children::{ForceCreateDirChildren, DirChildren};
    /// use dir_structure_tools::NoFilter;
    ///
    ...
    ///
    /// ```rust
    /// use dir_structure_tools::dir_children::{ForceCreateDirChildren, DirChild, DirChildren};
    /// use dir_structure_tools::NoFilter;
    ///
    /// let children = vec![
