    ...
    DirDescendants<T, F, P>
{
    ...
    ///
    /// ```
    /// use dir_structure_tools::{dir_descendants::{DirDescendants, DirDescendant}, NoFilter};
    ///
    ...
    ///
    /// ```
    /// use dir_structure_tools::{dir_descendants::{DirDescendants, DirDescendant, FileFilter, FolderFilter, FolderRecurseFilter}, NoFilter};
    ///
    /// struct MyFilter;
    ///
...
impl<T, P: PathType + ?Sized> DirDescendant<T, P> {
    ...
    /// use dir_structure_tools::dir_descendants::DirDescendant;
    ///
