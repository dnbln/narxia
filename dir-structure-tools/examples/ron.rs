//! An example demonstrating the use of [`Ron`](dir_structure::data_formats::ron::Ron) to read and write RON files.
//!
...
struct Dir {
    #[dir_structure(path = "data.ron", with_newtype = dir_structure_tools::data_formats::ron::Ron<ron::Value>)]
    data: ron::Value,
}

fn main() -> Result<(), Box<dyn Error>> {
    let path = example_dirs::get_example_dir_path("ron_rw");
