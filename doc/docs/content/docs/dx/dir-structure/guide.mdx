...
Helper trait, implemented for all types that have a [`ReadFrom`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/traits/sync/trait.ReadFrom.html)
and [`WriteTo`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/traits/sync/trait.WriteTo.html) implementation.
</DocTooltip>
...
[`DirStructureItem`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/traits/sync/trait.DirStructureItem.html).
</DocTooltip>
...
Uses the [`ReadFrom`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/traits/sync/trait.ReadFrom.html) implementation to read the structure from
...
Uses the [`WriteTo`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/traits/sync/trait.WriteTo.html) implementation to write the structure
...
or they are all files (which can be read with [`DirChildren`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/dir_children/struct.DirChildren.html)\<[`String`](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html)\> for example).

In either case, [`ReadFrom::read_from`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/traits/sync/trait.ReadFrom.html#tymethod.read_from) must be able to read all the entries in
the directory.

The [`WriteTo`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/traits/sync/trait.WriteTo.html) implementation will directly write the children to the directory it
...
A filter for the children of a [`DirChildren`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/dir_children/struct.DirChildren.html) structure.
...
For example, for a [`Filter`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/dir_children/trait.Filter.html) that only allows `.txt` files:
...
Creates a [`Filter`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/dir_children/trait.Filter.html) type that only allows files / folders with a specific [extension](https://doc.rust-lang.org/nightly/std/path/struct.Path.html#method.extension).
...
The only thing you can do with a [`DeferredRead`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read/struct.DeferredRead.html) is to call [`DeferredRead::perform_read`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read/struct.DeferredRead.html#method.perform_read),
which will read the file and return the value.

See the [`DeferredRead::perform_read`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read/struct.DeferredRead.html#method.perform_read) method for more details.
</DocTooltip>
...
If the value changed on disk since the [`DeferredRead`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read/struct.DeferredRead.html) was created, then the
...
This type exposes 2 functions: [`DeferredReadOrOwn::get`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read_or_own/enum.DeferredReadOrOwn.html#method.get) and
[`DeferredReadOrOwn::perform_and_store_read`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read_or_own/enum.DeferredReadOrOwn.html#method.perform_and_store_read).

The table below summarizes the differences between the two functions:

|State|[`DeferredReadOrOwn::get`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read_or_own/enum.DeferredReadOrOwn.html#method.get)|[`DeferredReadOrOwn::perform_and_store_read`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read_or_own/enum.DeferredReadOrOwn.html#method.perform_and_store_read)|
|-----|------------------------|-------------------------------------------|
...
As such, [`DeferredReadOrOwn::get`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read_or_own/enum.DeferredReadOrOwn.html#method.get) has the signature of `fn(&self) -> Result<T>` and
[`DeferredReadOrOwn::perform_and_store_read`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read_or_own/enum.DeferredReadOrOwn.html#method.perform_and_store_read) has the signature of `fn(&mut self) -> Result<&mut T>`.
...
that would effectively be the same as using a [`DeferredRead`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read/struct.DeferredRead.html), and that should be preferred instead.
</DocTooltip>
...
See [`DeferredReadOrOwn`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/deferred_read_or_own/enum.DeferredReadOrOwn.html) for more details.
...
Alternatively, for [`Eq`](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html) types, you can use the [`Versioned::edit_eq_check`](https://docs.rs/dir_structure/0.2.0-rc.3/dir_structure/versioned/struct.Versioned.html#method.edit_eq_check)
