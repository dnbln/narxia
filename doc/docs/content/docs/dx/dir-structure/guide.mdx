...
```rust ,ignore
pub struct DeferredRead<'a, T, Vfs = crate::FsVfs>(pub PathBuf, Pin<&'a Vfs>, PhantomData<T>)
```
...
`DeferredRead<'a, T, Vfs>::perform_read#`
...
```rust ,ignore
impl<'a, T, Vfs> DeferredRead<'a, T, Vfs>
...
`DeferredReadOrOwn<'a, T, Vfs>::perform_and_store_read#`
...
```rust ,ignore
impl<'a, T, Vfs> DeferredReadOrOwn<'a, T, Vfs>
