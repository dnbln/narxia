...
[`DeferredReadOrOwn::perform_and_store_read`](https://docs.rs/dir_structure/0.1.5/dir_structure/enum.DeferredReadOrOwn.html#method.perform_and_store_read) has the signature of `fn(&mut self) -> Result<&T>`.
