...
and write them back to disk."##
            ...
            #![doc = concat!(r##"use dir_structure_tools::data_formats::"##, stringify!($mod_name), "::", stringify!($main_ty), r##";"##)]
            //!
            ...
            {
                type Future = Pin<Box<dyn Future<Output = VfsResult<(), Vfs>> + Send + 'a>> where Self: 'a, Vfs: 'a;
